    ...
    do {
        ...
        when(opc){
            ...
            "5" -> {
                ...
                if(Database.guardarPeliculas()) println("${Colores.GREEN}🟢 Registros guardados...${Colores.RESET}")
                else println("${Colores.RED}❌ No se han podido guardar los registros...${Colores.RESET}")
            }
            else -> {
